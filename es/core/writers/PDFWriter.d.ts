...
declare class PDFWriter {
    ...
    serializeToBufferIncremental(snapshot: DocumentSnapshot): Promise<Uint8Array>;
    ...
    protected computeIncrementalBufferSize(snapshot: DocumentSnapshot, startOffset: number): Promise<SerializationInfo>;
