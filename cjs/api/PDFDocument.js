...
class PDFDocument {
    ...
    takeSnapshot() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const existingRefs = this.context
                ...
                .map(([ref]) => ref);
            return snapshot_1.IncrementalDocumentSnapshot.fromDocument(savedBytes, existingRefs);
        });
    }
    /**
    ...
    saveIncremental(options = {}) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { snapshot, useObjectStreams = true, addDefaultPage = true, objectsPerTick = 50, updateFieldAppearances = true, } = options;
            ...
            const incrementalBytes = yield Writer.forContext(this.context, objectsPerTick).serializeToBufferIncremental(snapshot);
            // Concatenate original bytes with incremental update
            const originalBytesFromSnapshot = snapshot.getOriginalBytes();
            const completeBytes = new Uint8Array(originalBytesFromSnapshot.length + incrementalBytes.length);
